...
<div class=leftSection>
  <div class= leftSection id= myInfo>
    <img id = "userPhoto" alt="userInfo" src="/NewTeamProject/images/userPhoto.png" width="70" height="83px">
  ...
  <div class="recommandTip">
    ...
    <div class="recommandpicture1"><img alt="추천1" src="/NewTeamProject/images/userPhoto.png"></div>
    <li class="recommandpicture1_userName">원지선과 난쟁이들</li>
    <div class="recommandpicture2"><img alt="추천2" src="/NewTeamProject/images/userPhoto.png"></div>

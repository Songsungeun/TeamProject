...
<section class="mainsector">
	<div class="adform">
		<div class="video"><img class="videoimg" src="../images/hyoju.jpg"></div>
		<div class="bestform">
		  <ul class="bestul">
  ...
  <div class="thumbbound">
    <div class="thumbimg"><img class="imgsize" src="../images/suji1.jpg"></div>
    <div class="thumbtext"><a href="#"> 썸네일 </a></div>
  </div>
  <div class="thumbbound">
    <div class="thumbimg"><img class="imgsize" src="../images/suji2.jpg"></div>
    <div class="thumbtext"><a href="#"> 썸네일 </a></div>
  </div>
  <div class="thumbbound">
    <div class="thumbimg"><img class="imgsize" src="../images/suji3.jpg"></div>
    <div class="thumbtext"><a href="#"> 썸네일 </a></div>
  </div>
  <div class="thumbbound">
    <div class="thumbimg"><img class="imgsize" src="../images/suji1.jpg"></div>
